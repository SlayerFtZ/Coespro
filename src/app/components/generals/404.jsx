        ...
        <div className="w-full md:w-1/2">
          ...
          <div className="mb-10 font-light text-gray-600 md:mb-20">
            <h1 className="mb-10 text-3xl font-black text-yellow-500 uppercase lg:text-5xl">
              Ocurrio un error 404!
            </h1>
            <p className="text-2xl font-bold text- mb-7">Pagina no encontrada</p>
            <p className="text-2xl font-bold text- mb-7">Contactate con soporte tecnico.</p>
          </div>
